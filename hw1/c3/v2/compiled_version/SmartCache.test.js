...
async function runTests() {
    ...
    {
        const cache = new SmartCache_1.SmartCache({ defaultTTL: 100 });
    ...
    testSection('Test 12: Persistence - Basic Save/Load');
    {
        ...
        const cache1 = new SmartCache_1.SmartCache({ persist: 'test_persist' });
        cache1.set('x', 100);
        cache1.set('y', 200);
        // Create new cache instance - should load from storage
        const cache2 = new SmartCache_1.SmartCache({ persist: 'test_persist' });
    ...
    testSection('Test 13: Persistence - Expired Entries Not Restored');
    {
        ...
        const cache1 = new SmartCache_1.SmartCache({ persist: 'test_persist_ttl' });
        ...
        const cache2 = new SmartCache_1.SmartCache({ persist: 'test_persist_ttl' });
    ...
    testSection('Test 14: Persistence - Updates Synced to Storage');
    {
        ...
        const cache1 = new SmartCache_1.SmartCache({ persist: 'test_persist_sync' });
        cache1.set('key', 111);
        const cache2 = new SmartCache_1.SmartCache({ persist: 'test_persist_sync' });
        assert(cache2.get('key') === 111, 'initial value synced');
        cache1.set('key', 222);
        const cache3 = new SmartCache_1.SmartCache({ persist: 'test_persist_sync' });
        assert(cache3.get('key') === 222, 'updated value synced');
        cache1.delete('key');
        const cache4 = new SmartCache_1.SmartCache({ persist: 'test_persist_sync' });
    ...
    testSection('Test 15: Persistence - Clear Synced to Storage');
    {
        ...
        const cache1 = new SmartCache_1.SmartCache({ persist: 'test_persist_clear' });
        cache1.set('a', 'alpha');
        cache1.set('b', 'beta');
        cache1.clear();
        const cache2 = new SmartCache_1.SmartCache({ persist: 'test_persist_clear' });
    ...
    testSection('DEMONSTRATION: 200 Dummy Cache Entries');
    {
        ...
        const demoCache = new SmartCache_1.SmartCache({
            maxSize: 250,
        ...
        const persistedCache = new SmartCache_1.SmartCache({ persist: 'demo_cache_200' });
